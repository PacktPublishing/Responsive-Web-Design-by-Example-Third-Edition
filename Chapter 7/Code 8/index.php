...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-4 col-md-6">
      <div class="card">
        <a href="post.php"><img class="card-img-top cardImage" src="https://venturebeat.com/wp-content/uploads/2013/03/hl2ep2postercropped.jpg?strip=all" alt="Card image cap"></a>

        <div class="card-block">
          <a href="post.php"><h4 class="card-title">Half-Life 3</h4></a>

          <p class="card-text">Half-Life 3 is coming in 2018, NO LIE!!!</p>
        </div>
      </div>
    </div>
